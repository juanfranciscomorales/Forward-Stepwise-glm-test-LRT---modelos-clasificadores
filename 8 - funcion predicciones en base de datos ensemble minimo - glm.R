...
clasificaciones.base.datos.ensemble.minimo.glm <- function (base.datos = "Dtest.xlsx",cant.modelos = 10, x = tabla.AUC.ordenadas.glm){
...
tabla.predicciones.base.datos <- clasificaciones.base.datos.ensemble.minimo.glm(base.datos  = "Dtest.xlsx",cant.modelos = 10, x = tabla.AUC.ordenadas.glm) ## si quiero que sea por AUC

tabla.predicciones.base.datos <- clasificaciones.base.datos.ensemble.minimo.glm(base.datos  = "Dtest.xlsx",cant.modelos = 10, x = tabla.sensibilidad.ordenadas) ## si quiero que sea por modelos con mayor sensibilidad
