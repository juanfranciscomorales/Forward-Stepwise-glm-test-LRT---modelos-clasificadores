...
clasificaciones.test.set.ensemble.voting.glm(test.set = "Dtest.xlsx",cant.modelos = 10,fraccion.votos = 0.5, x = tabla.sensibilidad.ordenadas)

clasificaciones.test.set.ensemble.voting.glm(test.set = "Dtest.xlsx",cant.modelos = 10,fraccion.votos = 0.5, x = tabla.AUC.ordenadas.glm) 