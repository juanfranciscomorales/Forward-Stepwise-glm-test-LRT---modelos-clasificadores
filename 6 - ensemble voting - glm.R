...
resultados.ensemble.voting <- combinacion.modelos.voting(x = tabla.sensibilidad.ordenadas, cant.modelos = 10,fraccion.votos = 0.5) # funcion para glm

resultados.ensemble.voting <- combinacion.modelos.voting(x = tabla.AUC.ordenadas.glm, cant.modelos = 10,fraccion.votos = 0.5) # funcion para glm